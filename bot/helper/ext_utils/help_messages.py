...
• <code>/mirror {video_link} -mkv ["mkvmerge -o mltb.SUB.EN.mkv mltb.video --language 0:eng https://example.com/subtitle.srt"]</code>
        ...
        for plugin_info in plugin_manager.list_plugins():
            if plugin_info.enabled and plugin_info.commands:
                for cmd in plugin_info.commands:
                    if cmd == "speedtest":
                        commands[""] = "Check Bot Speed using Speedtest.net"
